...
const projects = [
  ...
  {
    number: "05",
    name: "AI WhatsApp Business Automation Suite",
    company: "Sudarshan Pipes",
    type: "AI Automation",
    typeColor: "#a78bfa",
    typeBg: "rgba(139,92,246,0.12)",
    typeBorder: "rgba(139,92,246,0.3)",
    ...
    metrics: [
      { value: "2", label: "WhatsApp channels" },
      { value: "AI", label: "Auto-replies" },
      { value: "Auto", label: "Scheduled campaigns" },
    ],
  ...
  {
    number: "06",
    name: "ZiGBoT — AI Discord Companion",
    company: "Zig AI",
    type: "Discord AI Bot",
    typeColor: "#fbbf24",
    typeBg: "rgba(251,191,36,0.12)",
    typeBorder: "rgba(251,191,36,0.3)",
    problem: "Discord communities lacked a lightweight AI companion that could naturally join conversations, relieve stress with humor, and still provide secure server administration and voice/music features.",
    solution: "Built ZiGBoT — a Discord bot with bilingual (English + Hinglish) stress and banter trigger detection, sliding multi-turn conversation memory per channel, LLM-powered replies via NVIDIA NIM / OpenAI-compatible APIs, owner-gated administrative tooling with dual verification (configured ID plus real Discord guild ownership), audit logging, and an optional local Whisper/Piper voice pipeline with music playback.",
    result: "Delivered a production Discord bot combining natural AI conversation, security-hardened admin commands, and voice/music capability in one deployable package, with automated test coverage across every core module.",
    metrics: [
      { value: "Bilingual", label: "Trigger detection" },
      { value: "Owner-gated", label: "Admin security" },
      { value: "Voice+Music", label: "Built-in" },
    ],
  ...
  {
    number: "07",
    name: "AI-Assisted Product Catalogue Design",
    company: "Sudarshan Pipes",
    type: "AI Content & Design",
    typeColor: "#fb7185",
    typeBg: "rgba(251,113,133,0.12)",
    typeBorder: "rgba(251,113,133,0.3)",
    problem: "Sudarshan Pipes needed a professional, standards-compliant product catalogue for their Underground Drainage (UGD) pipe range to support sales and dealer outreach, without an in-house design team.",
    solution: "Designed and wrote an 8-page product catalogue covering company profile, brand journey, Solid Wall vs. Foam Core product comparison, and technical specifications aligned to IS 15328 and IS 16098 standards — using AI to structure and draft the technical and marketing copy, built out in Canva.",
    result: "Delivered a print-ready, professionally structured catalogue used directly in sales and dealer communications — later reused as source content for the WhatsApp AI assistant's product knowledge base.",
    metrics: [
      { value: "8", label: "Pages" },
      { value: "2", label: "IS standards" },
      { value: "AI+Canva", label: "Workflow" },
    ],
    stack: ["Canva", "AI Content Generation", "Technical Copywriting", "Brand Design"],
    links: [
      { label: "View PDF", href: "/UGD_catalogue.pdf", icon: ExternalLink },
    ],
  },
];
