  ...
  <footer style={{ borderTop: "1px solid hsl(var(--border))" }} className="py-8 px-6">
    <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        <span className="font-display font-bold text-sm text-gradient">Portfolio</span>
        <span className="font-mono text-xs text-muted-foreground">· Bhavesh Kumar Tiwari · Bengaluru, India</span>
      </div>
